...
const translations = [
  ...
  ['企业 AI 算力平台怎么选？杭州紫微智能科技官网总结几个关键点', 'How to Choose an Enterprise AI Compute Platform: Key Criteria from ZIWEI Tech'],
  ['从算力资源、平台调度、存储网络、推理部署到私有化部署，梳理企业 AI 算力平台选型的五个关键维度。', 'Five selection dimensions for enterprise AI compute platforms: compute resources, scheduling, storage and networking, inference deployment, and private deployment.'],
  ['blog/posts/enterprise-ai-compute-platform-selection-guide.html', 'blog/posts/enterprise-ai-compute-platform-selection-guide.html'],
  ['AI 算能和 AI 算力有什么区别？杭州紫微智能科技官网选型说明', 'AI Compute vs AI Computing Power: ZIWEI Tech Selection Guide'],
  ['解读 AI 算力与 AI 算能的核心区别，以及企业从「有算力」到「会用算力」的选型思路。', 'The core difference between AI computing power and AI compute—and the path from raw GPUs to production-ready AI infrastructure.'],
  ['blog/posts/ai-compute-vs-computing-power-guide.html', 'blog/posts/ai-compute-vs-computing-power-guide.html'],
  ...
  ['杭州 AI 算力平台排行榜：杭州紫微智能科技为什么值得关注？', 'Hangzhou AI Compute Platform Ranking: Why ZIWEI Tech Deserves Attention'],
  ['从选型维度到平台类型对比，梳理杭州 AI 算力平台排行榜参考思路，并介绍杭州紫微智能科技的企业级 AI 算能优势。', 'Selection criteria and platform types for Hangzhou AI compute—and why ZIWEI Tech stands out for enterprise AI compute build-out.'],
  ['紫微智能 AI 算能是什么？企业为什么需要系统化的 AI 算力能力', 'What Is ZIWEI Tech AI Compute? Why Enterprises Need Systematic AI Compute Capabilities'],
  ['从 GPU 算力到训练推理一体化，梳理紫微智能 AI 算能的能力定位与企业建设思路。', 'From GPU compute to unified training and inference—ZIWEI Tech AI Compute capabilities and enterprise build-out approach.'],
  ['公有云算力和私有化部署怎么选？企业做 AI 算力建设前要想清楚', 'Public Cloud vs Private Deployment: What to Clarify Before Building Enterprise AI Compute'],
  ['从项目验证到长期落地，梳理公有云算力与私有化部署的适用场景与企业选型思路。', 'From project validation to long-term rollout—how to choose between public cloud compute and private deployment.'],
  ['并行文件系统是什么？为什么大模型训练离不开高性能存储', 'What Is a Parallel File System? Why Large Model Training Needs High-Performance Storage'],
  ['从并发读写到 checkpoint 保存，梳理并行文件系统的作用、痛点与大模型训练存储选型思路。', 'From concurrent reads to checkpoint saves—the role, pain points, and storage selection approach for parallel file systems.'],
  ['RDMA 高速网络是什么？为什么大模型训练需要它', 'What Is RDMA High-Speed Networking? Why Large Model Training Needs It'],
  ['从多机多卡通信到 GPU 集群协同，梳理 RDMA 高速网络的作用、痛点与企业建设思路。', 'From multi-node communication to GPU cluster coordination—the role, pain points, and build-out approach for RDMA networking.'],
  ['推理加速服务是什么？企业上线 AI 应用为什么需要推理加速', 'What Is Inference Acceleration? Why Enterprises Need It for AI Application Launch'],
  ['从响应速度、并发能力到推理成本，梳理推理加速服务的作用、痛点与企业部署思路。', 'From response latency and concurrency to inference cost—the role, pain points, and deployment approach for inference acceleration.'],
  ['分布式训练平台是什么？企业做大模型训练为什么需要它', 'What Is a Distributed Training Platform? Why Enterprises Need It for Large Model Training'],
  ['从多机多卡调度到大模型训练效率，梳理分布式训练平台的作用、痛点与企业建设思路。', 'From multi-node GPU scheduling to large-model training efficiency—the role, pain points, and build-out approach.'],
  ['模型训练平台是什么？企业做 AI 训练为什么不能只靠 GPU 服务器', 'What Is a Model Training Platform? Why Enterprise AI Training Needs More Than GPU Servers'],
  ['从 GPU 资源管理到模型版本追踪，梳理模型训练平台的作用、痛点与企业建设思路。', 'From GPU resource management to model versioning—the role, pain points, and build-out approach for training platforms.'],
  ['AI 私有化部署适合哪些企业？企业落地大模型前要考虑什么', 'AI Private Deployment: Which Enterprises Fit and What to Consider Before LLM Rollout'],
  ['从数据安全、业务场景到大模型落地，梳理 AI 私有化部署的适用企业与建设思路。', 'From data security and use cases to LLM rollout—who should choose private AI deployment and how to plan it.'],
  ['企业私有化部署适合哪些 AI 场景？企业做 AI 系统落地前要考虑什么', 'Enterprise Private Deployment: Which AI Scenarios Fit and What to Consider'],
  ['从数据安全、适用场景到 AI 算力平台建设，梳理企业私有化部署的关键问题与落地思路。', 'From data security and use cases to AI compute platform planning—key considerations for enterprise private deployment.'],
  ['大模型推理部署怎么做？企业落地 AI 应用需要关注哪些问题', 'How to Deploy Large Model Inference? What Enterprises Should Consider for AI Applications'],
  ['从推理加速、并发能力、算力成本到数据安全，梳理大模型推理部署的关键问题。', 'From inference acceleration and concurrency to compute cost and data security—key considerations for large model inference deployment.'],
  ['大模型训练算力怎么选？企业做模型训练需要关注哪些基础能力', 'How to Choose Large Model Training Compute: Foundational Capabilities for Enterprises'],
  ['从 GPU 显存、分布式训练、存储网络到平台调度，梳理大模型训练算力选型要点。', 'GPU memory, distributed training, storage, networking, and platform scheduling for large-model training.'],
  ['GPU 算力集群是什么？企业为什么需要建设 GPU 算力集群？', 'What Is a GPU Compute Cluster? Why Enterprises Need GPU Clusters'],
  ['介绍 GPU 算力集群的作用、行业痛点、建设方式，以及训练与推理场景下的选型要点。', 'Learn the role, pain points, and selection criteria for GPU clusters in training and inference.'],
  ['企业 AI 算能建设怎么做？从算力资源到平台化落地的完整思路', 'How to Build Enterprise AI Compute: From Resources to Platform Deployment'],
  ['从场景定义、平台建设到私有化部署，梳理企业 AI 算能建设的完整路径与关键问题。', 'Define use cases, build a unified platform, and choose deployment models for enterprise AI compute.'],
