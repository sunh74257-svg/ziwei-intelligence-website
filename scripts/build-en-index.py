#!/usr/bin/env python3
"""Generate en/index.html from root index.html with path fixes and English copy."""
...
# Head SEO
head_old = """  <title>紫微智能科技 | AI 算能基础设施</title>
...
src = src.replace('lang="zh-CN"', 'lang="en"', 1)
...
src = src.replace(json_ld_old, json_ld_new)

# Lang switch active state on EN page
src = src.replace(
    'class="nav-lang-link is-active" data-lang="zh" aria-current="true"',
    'class="nav-lang-link" data-lang="zh" aria-current="false"',
)
src = src.replace(
    'class="nav-lang-link" data-lang="en" aria-current="false"',
    'class="nav-lang-link is-active" data-lang="en" aria-current="true"',
)
...
translations = [
    ...
    ('alt="AI 算力平台 3D 插画：云上传、服务器集群、AI 芯片与数据看板"', 'alt="AI compute platform 3D illustration: cloud upload, server clusters, AI chips and dashboards"'),
    ('aria-label="常见问题"', 'aria-label="FAQ"'),
    ('>常见问题<', '>FAQ<'),
    ('aria-label="立即体验紫微智能算力平台"', 'aria-label="Experience ZIWEI AI compute platform"'),
    ('>立即体验紫微智能算力平台<', '>Experience ZIWEI AI Compute Platform<'),
    ('>申请试用，获取免费技术方案与顾问咨询<', '>Request a trial for a free technical assessment and expert consultation<'),
    ('>立即咨询 <', '>Contact Us <'),
    ...
    ('平台支持 NVIDIA 主流 GPU 实例，训练平台兼容 PyTorch、TensorFlow 等常用框架，并提供分布式训练与弹性伸缩能力。', 'The platform supports mainstream NVIDIA GPU instances, is compatible with PyTorch, TensorFlow, and other popular frameworks, and offers distributed training with elastic scaling.'),
    ...
    ('企业客户可享受 7×24 专家支持。计费支持按需与包年包月等多种模式，详情请致电 400-888-8888 或发送邮件至 service@ziweitech.com。', 'Enterprise customers receive 24/7 expert support. Pricing includes on-demand and subscription models. Call 400-888-8888 or email service@ziweitech.com for details.'),
    ...
    ('aria-label="产品官网 A 能力标签"', 'aria-label="Product A capability tags"'),
    ('>心理陪伴<', '>AI companionship<'),
    ('>情绪疏导<', '>Emotional support<'),
    ('>智能问答<', '>Smart Q&A<'),
    ('基于 AI 技术的心理健康服务平台，提供心理陪伴、情绪疏导与智能问答，守护每一份心灵健康。', 'An AI-powered mental health platform offering companionship, emotional support, and smart Q&A to protect mental well-being.'),
    ('>访问官网 <', '>Visit Site <'),
    ('>了解更多<', '>Learn More<'),
    ('alt="心理健康 AI 平台产品界面示意"', 'alt="Mental health AI platform UI preview"'),
    ('alt="AI 算能平台图标"', 'alt="AI compute platform icon"'),
    ('>产品官网 B<', '>Product Site B<'),
    ('>AI 算能平台<', '>AI Compute Platform<'),
    ('aria-label="产品官网 B 能力标签"', 'aria-label="Product B capability tags"'),
    ('>算力调度<', '>Compute scheduling<'),
    ('>资源管理<', '>Resource management<'),
    ('>弹性扩展<', '>Elastic scaling<'),
    ('专业的 AI 算能基础设施平台，提供高效算力调度、资源管理与弹性扩展，助力企业智能化落地。', 'A professional AI compute infrastructure platform with efficient scheduling, resource management, and elastic scaling for enterprise AI adoption.'),
    ...
    ('自研 RDMA 高速网络，低延迟、稳定可靠。', 'Proprietary RDMA networking with low latency and high reliability.'),
    ('alt="模型训练平台图标"', 'alt="Model training platform icon"'),
    ('一站式训练平台，支持分布式训练与多种框架快速上手。', 'One-stop training platform with distributed training and popular framework support.'),
    ('alt="推理加速服务图标"', 'alt="Inference acceleration icon"'),
    ...
    ('影像分析、药物研发、基因计算', 'Medical imaging, drug discovery, and genomics compute'),
    ...
    ('alt="强大算力优势图标"', 'alt="Compute power advantage icon"'),
...
(out := ROOT / "en" / "index.html").write_text(src, encoding="utf-8")
